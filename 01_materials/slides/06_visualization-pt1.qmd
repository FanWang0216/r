...
2.  [Other aesthetics](#other-aesthetics)
3.  [Customization](#customization)
4.  [Adding complexity](#adding-complexity)

### Resources for this lesson

-   [Chapter 9: "Layers" in *R for Data Science (2nd ed.)*](https://r4ds.hadley.nz/layers.html)
