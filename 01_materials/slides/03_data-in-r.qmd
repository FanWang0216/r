...
2.  [Data types](#data-types)
    a.  [Doubles and integers (numbers)](#doubles-and-integers)
    b.  [Character strings](#character-strings)
    c.  [Logical](#logical-values)
    d.  [Factors](#factors)
    e.  [Dates and times](#dates-and-times)
3.  [Coercing between different types](#coercing-between-different-types)
4.  [Data frames and tibbles](#data-frames-and-tibbles)
...
### a. Doubles and integers {#doubles-and-integers}
...
It's unlikely that you'll need to make this distinction in practice – mostly you will just work with doubles.
...
### c. Logical values {#logical-values}
...
## Coercing between different types {#coercing-between-different-types}
...
You can then retrieve the columns as vectors using `$` or `[[]]` syntax:
